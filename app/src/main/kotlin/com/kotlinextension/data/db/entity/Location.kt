...
data class Location(
    ...
    @ColumnInfo(name = DatabaseAnnotation.USER_ID)
    val userId: Long,

    @SerializedName("street")
    @ColumnInfo(name = DatabaseAnnotation.STREET)
    val street: String,

    @SerializedName("city")
    @ColumnInfo(name = DatabaseAnnotation.CITY)
    val city: String,

    @SerializedName("state")
    @ColumnInfo(name = DatabaseAnnotation.STATE)
    val state: String,

    @SerializedName("postcode")
    @ColumnInfo(name = DatabaseAnnotation.POSTCODE)
    val postcode: String)
