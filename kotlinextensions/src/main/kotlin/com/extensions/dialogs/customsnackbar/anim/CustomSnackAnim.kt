...
class CustomSnackAnim(private val compositeAnim: AnimatorSet) {

    companion object {
        @JvmStatic
        fun with(context: Context) = CustomSnackAnimRetriever(context)
    }
...
class CustomSnackAnimRetriever(private val context: Context) {
    /**
     * Retrieves the builder for animating flashbar
     */
    fun animateBar() = CustomSnackAnimBarBuilder(context)

    /**
     * Retrieves the builder for animating the icon in the flashbar
     */
    fun animateIcon() = CustomSnackAnimIconBuilder(context)
}
