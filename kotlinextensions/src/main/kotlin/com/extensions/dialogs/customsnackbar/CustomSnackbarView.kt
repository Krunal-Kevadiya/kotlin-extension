...
import com.extensions.dialogs.customsnackbar.CustomSnackbar.Gravity
...
import com.extensions.dialogs.customsnackbar.CustomSnackbar.ProgressPosition.LEFT
import com.extensions.dialogs.customsnackbar.CustomSnackbar.ProgressPosition.RIGHT
...
import com.extensions.dialogs.customsnackbar.util.convertDpToPx
import com.extensions.dialogs.customsnackbar.util.getStatusBarHeightInPx
import com.extensions.dialogs.customsnackbar.view.ShadowView
import kotlinx.android.synthetic.main.flash_bar_view.view.*

/**
 * The actual CustomSnackbar withView representation that can consist of the title, message, button, icon, etc.
 ...
 */
internal class CustomSnackbarView(context: Context) : LinearLayout(context) {
    ...
    private lateinit var parentFlashbarContainer:CustomSnackbarContainerView
    ...
    internal fun addParent(flashbarContainerView:CustomSnackbarContainerView) {
    ...
    internal fun setBarTapListener(listener: CustomSnackbar.OnTapListener?) {
    ...
    internal fun setPrimaryActionTapListener(listener: CustomSnackbar.OnActionTapListener?) {
        if (listener == null) return
    ...
    internal fun setPositiveActionTapListener(listener: CustomSnackbar.OnActionTapListener?) {
        if (listener == null) return
    ...
    internal fun setNegativeActionTapListener(listener: CustomSnackbar.OnActionTapListener?) {
        if (listener == null) return
    ...
    internal fun startIconAnimation(animator: CustomSnackAnimIconBuilder?) {
    ...
    internal fun setProgressPosition(position: CustomSnackbar.ProgressPosition?) {
    ...
    internal fun setProgressTint(progressTint: Int?,
                                 position: CustomSnackbar.ProgressPosition?) {
