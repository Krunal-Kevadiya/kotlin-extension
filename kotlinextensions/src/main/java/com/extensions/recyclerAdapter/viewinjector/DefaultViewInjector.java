package com.extensions.recyclerAdapter.viewinjector;
...
import com.extensions.recyclerAdapter.RecyclerBindingViewHolder;
...
public class DefaultViewInjector implements IViewInjector<DefaultViewInjector> {
    ...
    public DefaultViewInjector(RecyclerView.ViewHolder viewHolder) {
